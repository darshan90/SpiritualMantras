			...
			public void run() 
			{
						...
						new DialogInterface.OnClickListener() 
				{
					...
					public void onClick(DialogInterface dialog,
						...
						String subject = "Jive+ Crash Report";
						...
						sendIntent.putExtra(Intent.EXTRA_EMAIL,
								new String[] { "shreyasdarshan2016@gmail.com" });
						...
						sendIntent.putExtra(Intent.EXTRA_TEXT, Constants.player_queue.get(iCurrentSongPostion)[0]);
						sendIntent.setType("text/plain");
